...
const InStockPage = ({ navigate }) => {
    ...
    const primaryHeaders = ['Model', 'Serial Number', 'Location', 'Status'];
    const addModalFields = ['Model', 'Serial Number', 'laptop warrenty and validity', 'Lifespan of laptop', 'Location', 'Status', 'Comment'];
    ...
    return (
        <PageShell pageTitle="Assets In Stock">
