/*
================================================================================
File: frontend/src/components/InStockPage.jsx
Instructions: This is the complete code for your "In Stock" page.
Replace your placeholder file with this code.
================================================================================
*/
...
const InStockPage = ({ navigate }) => {
    const collectionName = 'instock';
    // Define the fields specific to the In Stock form
    const modalFields = ['Model', 'Serial Number', 'laptop warrenty and validity', 'Lifespan of laptop', 'Location', 'Status', 'Comment'];
    ...
    const [filters, setFilters] = useState({ Model: '', Location: '' });
    ...
    const filterOptions = useMemo(() => {
        const options = { Model: new Set(), Location: new Set() };
        assets.forEach(asset => {
            Object.keys(options).forEach(key => {
                if (asset[key]) options[key].add(asset[key]);
            });
        });
        return { Model: [...options.Model], Location: [...options.Location] };
    }, [assets]);
    ...
    const handleDownload = () => {
        ...
        link.href = url;
        link.setAttribute('download', 'instock_assets_data.csv');
    ...
    return (
        <PageShell pageTitle="Assets In Stock" navigate={navigate}>
