/*
================================================================================
File: frontend/src/components/HeadsetPage.jsx
Instructions: This is the complete code for your "Headsets" page.
...
const HeadsetPage = ({ navigate }) => {
    const collectionName = 'headsets';
    // Define the fields specific to the Headsets form
    const modalFields = ['Headset ID', 'Type', 'Assigned to', 'Working Status', 'Issue Date'];
    ...
    const [filters, setFilters] = useState({ Type: '', 'Working Status': '' });
    ...
    const filterOptions = useMemo(() => {
        const options = { Type: new Set(), 'Working Status': new Set() };
        assets.forEach(asset => {
            Object.keys(options).forEach(key => {
                if (asset[key]) options[key].add(asset[key]);
            });
        });
        return { Type: [...options.Type], 'Working Status': [...options['Working Status']] };
    }, [assets]);
    ...
    const clearFilters = () => {
        setFilters({ Type: '', 'Working Status': '' });
    };
    ...
    const handleDownload = () => {
        ...
        link.href = url;
        link.setAttribute('download', 'headset_assets_data.csv');
    ...
    return (
        <PageShell pageTitle="Headsets" navigate={navigate}>
